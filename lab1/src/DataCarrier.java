...
public class DataCarrier {
	...
	public  String getValue() {
        ...
        int stateVal = getP0() + 2*getP1() + 4*getP2() + 8*getP3() + 16*getP4();
        String funcName = "getV" + stateVal;
        Class cls = this.getClass();
        Method methlst[] = cls.getDeclaredMethods();
        for(Method m : methlst)
        {
	...
	{
		return ((getP0() == 0||getP0() == 1)&&(getP1() == 0||getP1() == 1)&&(getP2() == 0||getP2() == 1)
				&&(getP3() == 0||getP3() == 1)&&(getP4() == 0||getP4() == 1));
	}
